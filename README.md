...
The python file was mostly designed by Gabriel Lau and can handle turning a string into a boolean truth table. It can only handle equations where each variable is repeated once. <br>
